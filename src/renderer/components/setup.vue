       ...
       <div class="layout-container">
         <div class="layout-now">
            ...
            <ul class="layout-list" v-show="showLayouts">
              <li v-for="item in layouts" v-show="item.show" v-bind:key='item.id' :class="item.class" @click.stop="setLayout('changeLayout',item.name,item.direct)"><img :src="item.image" alt=""></li>
            </ul>
         </div>
     </div>
            ...
            //  console.log(this.nowLayout)
             ...
             //if(val.indexOf('minder')>-1){
              //  console.log()
                ...
                // }
              //  console.log(val)
                 var layout=this.layouts.filter(item=>item.name==val&&(item.direct==this.layoutDirect))[0];
                 this.nowLayout=layout;
               // console.log(this.nowLayout)
