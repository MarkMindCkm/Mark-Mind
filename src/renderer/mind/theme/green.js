const green={
    ...
    config:{
        //主根节点
        'main-root-fill':'rgb(83,174,127)',             //填充色
        ...
        //自由节点（根节点）
        'free-root-fill':'rgb(242,242,242)',
        ...
        //自由节点（二级节点）
        'free-second-node-fill':'rgb(242,242,242)',
        ...
        'lineWidth':2,                    //连线粗细
        //canvas 设置
        'background':'rgb(242,242,242)',               //画布背景色
        //关联线
        'relate-stroke':'#999',                //关联线颜色
        'relate-textFill':'#999',              //关联线文字颜色
        //外框
        'wireFrame-stroke':'rgb(1,149,164)',              //外框 颜色
        'wireFrame-fill':'rgba(0,149,164,0.2)',                   //外框填充色
        //总结
        'induce-stroke':'rgb(1,149,164)',                 //总结 线的颜色
