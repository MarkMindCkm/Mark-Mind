...
export default class TreeLayout extends Layout {
	...
	// 			//   }else{
	// 			var stroke = child.stroke || '#f5f5f5';
	// 			//   }
	...
	// 						cpx1: fromPoint.x - 8,
	// 						cpy1: fromPoint.y + 10,
	// 						cpx2: toPoint.x - (toPoint.x - fromPoint.x) / 6,
	// 						cpy2: fromPoint.y - 6
	// 					}
	// 				});
	// 			}
	...
	// 			let toPoint = {
	// 				x: childPos.x + childBox.width / 2,
	// 				y: childPos.y + childBox.height
	// 			};
	// 			//   let theme=me.getConfig();
	// 			//   if(theme){
	// 			//     var  stroke=theme.data.lineColor;
	// 			//   }else{
	// 			var stroke = child.stroke || stroke || '#f5f5f5';
	// 			//   }
	// 			if (node.getChildren().length == 1) {
	// 				var line = new zrender.Line({
	// 					style: {
	...
	// 	}
	// 	createLine(root);
	// 	this.root.getRoot().addLine(this.gLine);
	// }
